...
class LostReportController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'reporter_instagram' => ['nullable', 'string', 'max:100'],
            'reporter_id_type' => ['nullable', 'string', 'max:50'],
            'reporter_id_number' => ['nullable', 'string', 'max:50'],
        ...
        try {
            ...
            $lostReport = LostReport::create([
                ...
                'reporter_instagram' => $request->reporter_instagram ? ltrim(trim($request->reporter_instagram), '@') : null,
                'reporter_id_type' => $request->input('reporter_id_type', 'KTP'),
                'reporter_id_number' => $request->input('reporter_id_number', '-'),
